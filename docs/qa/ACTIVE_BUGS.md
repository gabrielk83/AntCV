...
>
> **Verification:** suite 1257/1257; three diags GREEN (shape 8/8, remove-last-reset 9/9 still, slogan 6/6). Quartet 1.51.499-owner-followups (photo-library + both slogan ?v, seed, version-override ?v + TARGET + STALE append 1.51.478-demand-seed-refresh, sw.js CACHE). Shift lane 1.51.498-1.51.517, isolated worktree.
