> **AUTHORITATIVE current state + copy-paste next-session prompt: `docs/qa/NEXT_SESSION_2026-06-29.md`** (PWA **1.50.961** + docx-worker **1.14.94** + access-relay **1.3.2**; suite 521/521). Read it FIRST. CRITICAL data-loss is FIXED (relay 1.3.2 + client guard 1.50.957). Top OPEN = the render-gated CV 3-page convergence (A) + candidate-header contacts-spread-left (B) — same page-1-grid root, need the owner's real CloudConvert export. Older: `docs/qa/NEXT_SESSION_2026-06-28.md`.
>
