...
## Session 2026-06-12 additions (GEN-SCE-FLAG-001, GEN-LANGFAB-001)

> Triaged from a live Trackman regeneration on mobile (~09:08 CET). Same run also confirmed
> the SO-003 update (regeneration does not refill the wiped Selected Outcomes — see SO-003)
> and a correct GEN-ROLEFORM-001 outcome (split pair, no merged duplicate).
