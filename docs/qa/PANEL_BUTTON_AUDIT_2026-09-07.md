# Panel/preview button audit — 2026-09-07 (NIGHTLY-PREVIEW-BUTTON-AUDIT-001, register row 23)

Harness: pwa/test/diag-panel-button-audit.mjs (real browser boot, network blocked, dialogs dismissed).
Bundle: 1.51.4246-era app.js; buttons enumerated: 215.
...
Raw JSON: PANEL_BUTTON_AUDIT_2026-09-07.json