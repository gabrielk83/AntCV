# Panel/preview button audit — 2026-09-08 (NIGHTLY-PREVIEW-BUTTON-AUDIT-001, register row 23)

Harness: pwa/test/diag-panel-button-audit.mjs (real browser boot, network blocked, dialogs dismissed).
Bundle: 1.51.4246-era app.js; buttons enumerated: 209.

## Verdict counts
- skipped-dangerous: 14
- ui-only: 16
- active: 133
- not-visible-or-disabled: 46
...
Raw JSON: PANEL_BUTTON_AUDIT_2026-09-08.json