...
> **SHIPPED 2026-07-15 — PWA `1.51.1504-slogan-unsol-generic` (option (a)). ✅ OWNER-CONFIRMED RESOLVED 2026-07-15.** All three parts landed, kill-switchable via `antcv:disable-slogan-unsol-generic`:
