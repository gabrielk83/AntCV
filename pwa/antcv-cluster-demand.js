 ...
 * cluster_top20_research_2026-07-24.json, latest — supersedes the 2026-07-13
 * revision; 2026-07-24 run was 11 days stale (2026-07-17 fire silently
 * no-op'd, see docs/qa/SCHEDULED_ROUTINES.md STANDING RULE 0), so all 9
 * clusters carried evidence-backed changes: AI/GenAI fluency continues
 * climbing everywhere, several clusters promoted human-differentiator skills
 * — critical thinking, business acumen, EI, communication — as AI absorbs
 * mechanical work) — together the 9 clusters the 12 categories fold
 * into. This is the
...
(function () {
  ...
  var SEED = {
    pm_process: { label: 'PM / Product / Process Management', top20: [
      ...
      [2, 'Stakeholder management, cross-functional coordination & conflict resolution', 'ABC'],
      [3, 'Requirements management & translating needs into specs', 'AB'],
      [4, 'AI/GenAI tool fluency in delivery & EU AI Act awareness', 'ABC'],
      [5, 'Risk identification, assessment & mitigation (risk register)', 'AB'],
      [6, 'Business/commercial acumen & financial understanding', 'AB'],
      [7, 'Process design, modelling & documentation (BPM / BABOK / BPMN)', 'none'],
      [8, 'Process / continuous improvement (Lean / Six Sigma)', 'AB'],
      [9, 'Change & governance control', 'none'],
      ...
      [13, 'ERP / CRM or system-implementation experience', 'none'],
      [14, 'Hardware product development (mechanics/electronics/RF)', 'AB'],
      [15, 'Design verification & validation vs specifications', 'AB'],
      [16, 'International product certification (CE / FCC / UL / EASA-145)', 'none'],
      [17, 'Audit / compliance & CAPA handling', 'none'],
      [18, 'Status communication to senior management / board', 'ABC'],
      [19, 'Systems-level thinking & managing complexity in matrix/multi-project environments', 'AB'],
    ...
    photonics_eng: { label: 'Photonics / Optical / Test Engineering', top20: [
      ...
      [8, 'Foundry PDKs & simulation tools (COMSOL, Zemax, FDTD/Lumerical)', 'BC'],
      [9, 'Data acquisition, automation & analysis (Python, LabVIEW)', 'BC'],
    ...
    engineering_software: { label: 'Software Engineering', top20: [
      ...
      [6, 'Agile / Scrum delivery & iteration', 'AB'],
      [7, 'Data structures, algorithms & problem-solving', 'none'],
      [8, 'Version control & collaborative workflows (Git)', 'AB'],
      [9, 'Databases, SQL & data modelling (SQL / NoSQL)', 'AB'],
      [10, 'Containerisation & orchestration (Docker / Kubernetes)', 'none'],
      [11, 'API design & microservices (REST / gRPC)', 'none'],
      [12, 'Secure coding & application security (NIS2 compliance)', 'none'],
      [13, 'Infrastructure as code & platform engineering (Terraform / developer portals)', 'none'],
    ...
    data_analytics: { label: 'Data & Analytics', top20: [
      ...
      [4, 'AI/agentic tools & prompt engineering for analytics workflows', 'ABC'],
      [5, 'Statistics & probability (hypothesis testing)', 'none'],
      [6, 'Machine learning & predictive modelling', 'none'],
      [7, 'Data cleaning, wrangling & quality', 'none'],
      [8, 'Data pipelines & warehousing (dbt / Snowflake / Spark)', 'none'],
      [9, 'Excel / spreadsheet modelling', 'AB'],
      ...
      [13, 'Cloud data platforms (BigQuery / Databricks / Azure)', 'none'],
      [14, 'Dashboard & KPI reporting', 'none'],
      [15, 'Critical thinking & problem-solving', 'ABC'],
      [16, 'Experiment design & A/B testing', 'none'],
      [17, 'Domain / industry knowledge', 'AB'],
      [18, 'Version control & reproducible analysis (Git)', 'none'],
      [19, 'Data governance, privacy & ethics', 'none'],
      [20, 'English fluency (Danish an advantage)', 'ABC']
    ] },
    consulting: { label: 'Consulting', top20: [
      ...
      [4, 'Client relationship & stakeholder management', 'ABC'],
      [5, 'Executive communication & storytelling (slides)', 'none'],
    ...
    executive: { label: 'Executive / Senior Leadership', top20: [
      ...
      [2, 'AI & digital strategy fluency (incl. AI governance)', 'ABC'],
      [3, 'Emotional intelligence & people leadership', 'ABC'],
      [4, 'P&L ownership & financial stewardship', 'AB'],
      [5, 'Building & leading high-performing teams', 'ABC'],
      [6, 'Stakeholder, board & investor communication', 'ABC'],
      [7, 'Organisational change & transformation leadership', 'AB'],
      [8, 'Coaching, culture & talent development', 'AB'],
      [9, 'Commercial growth & revenue architecture', 'AB'],
      [10, 'Financial acumen (EBITDA, balance sheet, ROI)', 'AB'],
      [11, 'Governance, risk, cybersecurity & ESG/CSRD compliance oversight', 'AB'],
      [12, 'Judgment & decision-making under ambiguity', 'none'],
      [13, 'Operational excellence & execution', 'none'],
      [14, 'Cross-functional & enterprise-wide alignment', 'ABC'],
      [15, 'Resilience, adaptability & learning agility', 'none'],
      [16, 'Negotiation & partnership building', 'AB'],
      [17, 'Vision communication & influence', 'ABC'],
      [18, 'Global / multi-market & cross-cultural leadership', 'none'],
      [19, 'Market & competitive strategy', 'AB'],
      [20, 'English fluency (Danish an advantage)', 'ABC']
    ] },
    finance: { label: 'Finance', top20: [
      [1, 'Financial reporting & month-end close', 'none'],
      [2, 'Data analysis & SQL fundamentals', 'AB'],
      [3, 'Financial modelling & forecasting (FP&A)', 'AB'],
      [4, 'AI & automation in finance', 'ABC'],
      [5, 'Advanced Excel & spreadsheet analysis', 'AB'],
      [6, 'BI & data visualisation (Power BI / Tableau)', 'AB'],
      [7, 'ERP & finance systems (SAP / Oracle / NetSuite)', 'AB'],
      [8, 'Budgeting, planning & variance analysis', 'none'],
      [9, 'Business partnering & stakeholder communication', 'ABC'],
    ...
    people_soft: { label: 'People / HR', top20: [
      ...
      [3, 'Critical thinking, complex problem-solving & judgment', 'ABC'],
      ...
      [6, 'Employee relations & labour-law compliance', 'none'],
      [7, 'People analytics, data storytelling & data-driven HR', 'AB'],
      [8, 'HRIS & people systems (Workday / SuccessFactors / Power BI)', 'AB'],
      [9, 'Strategic workforce planning & succession planning', 'AB'],
      [10, 'Coaching, influencing, emotional intelligence & learning agility', 'ABC'],
