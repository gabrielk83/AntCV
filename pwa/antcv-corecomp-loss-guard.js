...
(function () {
  ...
  // Chinese generation's cached core competencies were re-injected into a later ENGLISH
  // generation during the skeleton window (empty section -> reapply) — the doc "started in
  // Chinese, then switched to English". Include the current output language in the key so a
