...
(function () {
  ...
  const TARGET_VERSION = '1.51.4506-qa-page-foundation-fold';
  ...
  const STALE_VERSIONS = [
    ...
    '1.51.4346-cost-rates',
    '1.51.4326-claude-rate',
    '1.51.4306-demand-seed-refresh',
    '1.51.4286-years-guard',
    '1.51.4266-cl-greeting',
    '1.51.4246-template-floor',
    '1.51.4226-globalise-v3',
    '1.51.4206-profile-dedup',
    ...
    '1.51.4024-cl-open-brandfix',
    '1.51.4003-applist-meta-edit',
    '1.51.3983-cl-opening-seed',
    '1.51.3982-inline-edit-appline',
    ...
    '1.51.3742-load-no-retranslate',
    '1.51.3722-demand-seed-refresh',
    '1.51.3702-photo-center',
    '1.51.3686-name-width4',
    '1.51.3685-name-width3',
    '1.51.3684-name-width2',
    '1.51.3683-name-width',
    '1.51.3682-cph-storm',
    '1.51.3622-stage4-docx',
    '1.51.3602-header-lock',
    '1.51.3582-fit-abs',
    '1.51.3562-fit-last',
    '1.51.3542-fit-guard',
    ...
    '1.51.3382-photo-center',
    '1.51.3362-band-fit',
    '1.51.3342-sidebar-track',
    '1.51.3322-band-symmetry3',
    '1.51.3302-band-symmetry2',
    '1.51.3282-spec-midline',
    '1.51.3262-band-symmetry',
    '1.51.3242-edu-canon-pin',
    '1.51.3222-quick-doc-color',
    '1.51.3182-band-size2',
    '1.51.3161-band-size',
    '1.51.3141-band-gap',
    ...
    '1.51.2721-app-save-guard',
    '1.51.2701-quick-contact-scope',
    '1.51.2680-hourglass-storm',
    '1.51.2661-cl-v5-rerender-force',
    '1.51.2641-cl-v5-why-roleview',
    '1.51.2622-cl-cv-two-tone',
    '1.51.2601-header-elem-colors',
    '1.51.2600-rowfit-hourglass',
    '1.51.2561-cl-spec-center',
    '1.51.2541-cl-heading-spec',
    '1.51.2520-application-line',
    '1.51.2501-contact-collapse-fix',
    '1.51.2480-application-line',
    '1.51.2461-cl-no-photo',
    '1.51.2460-rowfit-marker-underline',
    '1.51.2440-application-line',
    '1.51.2420-application-line',
    '1.51.2401-analysis-header-editor-gate',
    '1.51.2400-application-line',
    '1.51.2379-title-lang-heal',
    '1.51.2359-cl-skeleton-seed-storm',
    '1.51.2339-copenhagen-photo-bridge',
    ...
    '1.51.1558-unsol-subtitle-slogan-gate',
    '1.51.1557-role-merge-swallow',
    '1.51.1556-pdf-panel-worker',
    '1.51.1544-brand-parity',
    '1.51.1524-leadin-underline',
    '1.51.1504-slogan-unsol-generic',
    '1.51.1484-slogan-dangle-cap',
    '1.51.1464-rolehead-justify',
    '1.51.1425-tracker-open-claim',
    '1.51.1424-edu-row-cjlr',
    '1.51.1404-slogan-lang-gate',
    '1.51.1384-header-seam',
    '1.51.1344-meta-stick-load-editor',
    '1.51.1304-slogan-brand-color',
    '1.51.1265-autopages-role',
    '1.51.1264-roles-cutover',
    '1.51.1244-photo-nudge',
    '1.51.1225-headline-cjlr3',
    '1.51.1224-headline-cjlr2',
    '1.51.1204-cjlr-rerender',
    '1.51.1185-headline-cjlr2',
    '1.51.1184-headline-cjlr',
    '1.51.1184-headline-cjlr',
    '1.51.1164-slogan-ctl',
    '1.51.1144-slogan-enhance',
    '1.51.1126-cjlr-persist',
    '1.51.1125-cjlr-emit-fix',
    '1.51.1124-spell-apply',
    '1.51.1106-roles-default-on',
    '1.51.1105-rowkey-match',
    '1.51.1104-spell-nudge',
    '1.51.1085-grpkeep',
    '1.51.1084-slogan-vis',
    '1.51.1065-group-scope',
    '1.51.1064-edit-lag-spec',
    '1.51.1046-group-cjlr-redeploy',
    '1.51.1045-group-cjlr',
    '1.51.1044-edit-stable',
    '1.51.1025-per-row-live',
    '1.51.1024-contact-parity',
    '1.51.1005-per-row-cjlr',
    ...
    '1.51.883-editable-marks',
    '1.51.882-seam-fallback',
    '1.51.862-slogan-seam',
    '1.51.842-photo-flip-anchor',
    '1.51.823-edit-focus-002',
    '1.51.822-contact-nobullet',
    '1.51.802-photo-flip-redetect',
    '1.51.785-edit-freeze',
    '1.51.784-photo-flip-model',
    '1.51.783-brand-style-uncheck',
    '1.51.782-align-dance-fix',
    '1.51.781-photo-flip-detect',
    '1.51.761-photo-flip',
    '1.51.747-edit-focus-stable',
    '1.51.746-slogan-place-ctrl',
    ...
    '1.51.578-cost-tiebreak',
    '1.51.538-compress-openai-drop',
    '1.51.499-owner-followups',
    '1.51.478-demand-seed-refresh',
    '1.51.438-personal-dedup',
    '1.51.418-photo-carousel',
    '1.51.397-matrix-rowspec',
    '1.51.396-matrix-containment',
    '1.51.395-jd-remove-sticky',
    '1.51.394-role-canon-lang',
    ...
    '1.51.377-balance-lastpage',
    '1.51.376-sidebar-balance',
    '1.51.375-width-hints',
    ...
    '1.51.363-history-save-time',
    '1.51.362-role-covers',
    '1.51.361-analysis-on-open',
    '1.51.360-open-jd-visible',
    '1.51.359-per-app-identity',
    '1.51.358-role-twins',
    '1.51.357-translate-target',
    '1.51.356-identity-heal',
    '1.51.355-relang-single-flight',
    '1.51.354-gen-keys-capture',
    '1.51.353-same-id-position',
    '1.51.352-adequacy-scope',
    '1.51.351-gen-budget',
    '1.51.350-ratio-invariant',
    '1.51.349-kernel-table-time',
    '1.51.348-cw-canon-lang',
    '1.51.347-crossco-match',
    '1.51.346-loop-standdown',
    '1.51.345-foundation-loop-fix',
    '1.51.344-contact-crash-fix',
    '1.51.343-owner-pins',
    '1.51.342-pi-echo-guard',
    '1.51.341-lang-restore-guard',
    '1.51.340-langs-dict',
    '1.51.339-tighten-window',
    '1.51.338-dedup-unicode',
    '1.51.337-babel-native',
    '1.51.336-pi-contact',
    '1.51.335-pi-identity',
    '1.51.334-unsol-pillar',
    ...
    '1.51.324-babel-invariant',
    '1.51.323-babel-cloud-cache',
    '1.51.322-wizard-new-user',
    '1.51.321-babel-cache',
    '1.51.320-babel-relang',
    '1.51.300-tab-doc-iso',
    '1.51.262-babel-lang-name',
    '1.51.261-byok-brave',
    '1.51.260-shift-versionfix',
    '1.51.260-lang-dropdown-current',
    '1.51.260-demand-seed-refresh',
    ...
    '1.51.234-jobtracker-research',
    '1.51.233-langbar-zh',
    '1.51.232-lang-modal-ghost',
    ...
    '1.50.984', '1.50.985', '1.50.986', '1.50.987', '1.50.988', '1.50.989', '1.50.990', '1.50.991', '1.50.992', '1.50.993', '1.50.994', '1.50.995', '1.50.996', '1.50.997', '1.50.998', '1.50.999', '1.51.0', '1.51.1', '1.51.2', '1.51.3', '1.51.4', '1.51.5', '1.51.6', '1.51.7', '1.51.8', '1.51.9', '1.51.10', '1.51.11', '1.51.12', '1.51.13', '1.51.14', '1.51.15', '1.51.16', '1.51.17', '1.51.18', '1.51.19', '1.51.20', '1.51.21', '1.51.22', '1.51.23', '1.51.24', '1.51.25', '1.51.26', '1.51.27', '1.51.28', '1.51.29', '1.51.30', '1.51.31', '1.51.32', '1.51.33', '1.51.34', '1.51.35', '1.51.36', '1.51.37', '1.51.38', '1.51.39', '1.51.40', '1.51.41', '1.51.42', '1.51.43', '1.51.44', '1.51.45', '1.51.46', '1.51.47', '1.51.48', '1.51.49', '1.51.50', '1.51.51', '1.51.52', '1.51.53', '1.51.54', '1.51.55', '1.51.56', '1.51.57', '1.51.58', '1.51.59', '1.51.60', '1.51.61', '1.51.62', '1.51.63', '1.51.64', '1.51.65', '1.51.66', '1.51.67', '1.51.68', '1.51.69', '1.51.70', '1.51.71', '1.51.72', '1.51.73', '1.51.74', '1.51.76', '1.51.77', '1.51.78', '1.51.75', '1.51.79', '1.51.80', '1.51.81', '1.51.82', '1.51.83', '1.51.84', '1.51.85', '1.51.86', '1.51.87', '1.51.88', '1.51.89', '1.51.90', '1.51.91', '1.51.92', '1.51.93', '1.51.94', '1.51.95', '1.51.96', '1.51.97', '1.51.98', '1.51.99', '1.51.100', '1.51.101', '1.51.102', '1.51.103', '1.51.104', '1.51.105', '1.51.106', '1.51.107', '1.51.108', '1.51.109', '1.51.110', '1.51.111', '1.51.112', '1.51.113', '1.51.114', '1.51.115', '1.51.116', '1.51.117', '1.51.118', '1.51.119', '1.51.120', '1.51.121', '1.51.122', '1.51.123', '1.51.124', '1.51.125', '1.51.126', '1.51.127', '1.51.128', '1.51.129', '1.51.130', '1.51.131', '1.51.132', '1.51.133', '1.51.134', '1.51.135', '1.51.136', '1.51.137', '1.51.138', '1.51.139', '1.51.140', '1.51.141', '1.51.142', '1.51.143', '1.51.144', '1.51.145', '1.51.146', '1.51.147', '1.51.148', '1.51.149', '1.51.150', '1.51.151', '1.51.152', '1.51.153', '1.51.154', '1.51.155',
